    ...
    const [hallAndLabDetails] = useState([
      {
        type: 'hall',
        data: [
  { id: 101, name: 'Karachi Expo Hall', venue: 'Karachi Expo Center', seating: 1000 },
  { id: 102, name: 'Karachi International Exhibition Center', venue: 'Karachi Expo Center', seating: 1500 },
  { id: 103, name: 'Mohatta Palace Auditorium', venue: 'Mohatta Palace', seating: 200 },
  { id: 104, name: 'Pearl Continental Hotel Ballroom', venue: 'Pearl Continental Hotel', seating: 500 },
  { id: 105, name: 'Karachi Arts Council Hall', venue: 'Karachi Arts Council', seating: 300 },
  { id: 106, name: 'KMC Sports Complex Hall', venue: 'KMC Sports Complex', seating: 1000 }
]
    ...
    const actions = [
      ...
      { icon: <span>Availability</span>, name: 'Check Availability', action: openCheckAvailabilityDialog },
      {
        icon: (
          <Link
            to={{ pathname: '/CustomerReviews', state: { username } }}
            style={{ textDecoration: 'none', color: 'inherit' }}
          >
            <span>Reviews</span>
          </Link>
